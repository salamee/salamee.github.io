...
context.fillText("But Beware of the boxes that are bigger than you, you cannot eat it, or else it'll be game over.",300,90);
context.fillText("But you can eat these bigger boxes once you are bigger than the big boxes.",350,110);
context.fillText("Eat all the boxes as fast as you can to win.",500,130);
