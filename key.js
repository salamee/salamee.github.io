...
context.fillText("Remember you can only eat these small boxes, and eating them will make your box bigger.",175,70); 
context.fillText("But Beware of the boxes that are bigger than you, you cannot eat it, or else it'll be game over.",175,90);
context.fillText("But you can eat these bigger boxes once you are bigger than the big boxes.",175,110);
context.fillText("Eat all the boxes as fast as you can to win.",175,130);
context.fillText("Remember!! The more time you take, the less points you have.",175,150);
context.fillText("PRESS ANY KEY TO START",600,200)
